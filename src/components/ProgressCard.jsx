...
function ProgressCard() {
  return (
    <div className="bg-pink-200 w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg p-5 rounded-2xl flex flex-col items-center text-center shadow-md mx-auto">
      ...
      <div className="flex justify-center my-4">
        <img
          src="https://t4.ftcdn.net/jpg/13/09/38/57/360_F_1309385796_AWV5gBSNLgpORUFYWi7ZL3hACL9463kq.jpg"
          alt="Robot"
